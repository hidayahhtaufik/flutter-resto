...
//GLOBAL VAR
var textYellow = Color(0xFFf6c24d) || Color(0xFF398bcf);
...
var yellow = Color(0xFFf6c24d)
var yellowLight = Color(0xFFf4bf47);

var blue = Color(0xFF398bcf);
var blueLight = Color(0xFFc1dbee);
var dagingImage =
    'https://images.unsplash.com/photo-1607623814075-e51df1bdc82f?ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTh8fG1lYXR8ZW58MHx8MHx8&ixlib=rb-1.2.1&w=1000&q=80';

var hamburgerImage =
    'https://cf.shopee.co.id/file/7597b25870008fb83ab0decb254c9fb7';
          ...
          child: Row(
            ...
            children: <Widget>[
              Column(
                children: <Widget>[
                  Icon(Icons.home),
                  Text('Home', style: TextStyle(fontSize: 12.2))
                ],
              ),
              Column(
                children: <Widget>[
                  Icon(Icons.search, color: Colors.black45),
                  Text('Search', style: TextStyle(fontSize: 12.2))
                ],
              ),
              Container(
                width: 101.0,
              ...
              Column(
                children: <Widget>[
                  ...
                  Text('Cart', style: TextStyle(fontSize: 12.2))
                ],
              ),
            ],
          ),
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: <Widget>[
          Text(
            'Popular Dishes',
            style: TextStyle(fontSize: 22.2, color: Colors.black54),
          ),
      ...
      child: Container(
          ...
          decoration: BoxDecoration(
              image: DecorationImage(
                  image: NetworkImage(dagingImage), fit: BoxFit.cover)),
          child: Stack(
            children: <Widget>[
              Container(
                height: 160.0,
